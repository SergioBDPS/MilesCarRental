        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarLocationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cars_Locations_CarLocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Locations_UserLocationsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentLocationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DiferentLocation = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_Locations_RentLocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_RentLocationId",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cars_CarLocationId",
                table: "Cars",
                column: "CarLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Users_UserLocationsId",
                table: "Users",
                column: "UserLocationsId");
        }
